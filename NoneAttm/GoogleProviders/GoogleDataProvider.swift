...
class GoogleDataProvider {
    ...
    func fetchPlacesNearCoordinate(_ coordinate: CLLocationCoordinate2D, types: [String], keyword: String, completion: @escaping PlacesCompletion) -> Void {
        var urlString = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=\(coordinate.latitude),\(coordinate.longitude)&rankby=distance&sensor=true&keyword=\(keyword)&key=\(googleApiKey)"
